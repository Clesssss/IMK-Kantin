                ...
                $(document).on('click', '.edit-stall', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#editStallImage').val(data.image); // Set image URL
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-secondary edit-stall" data-stallid="<?= $stall['stall_id']; ?>">Edit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
